function H = pileSimilarity_RSAtoolbox(RowData,SPM)
...
for r = 1:4
    ...
    c1L(1,r) = mean(CC1(DistMs.Hex==1)) - mean(CC1(DistMs.Hex==2));
    c1L(2,r) = mean(CC1(DistMs.Hex==1)) - mean(CC1(DistMs.Hex==3));
   ...
   % To hex 2:
    ...
    c2L(1,r) = mean(CC2(DistMs.Hex==1)) - mean(CC2(DistMs.Hex==2));
    c2L(2,r) = mean(CC2(DistMs.Hex==1)) - mean(CC2(DistMs.Hex==3));
    ...
    c3L(1,r) = mean(CC3(DistMs.ClustSmall==1)) - mean(CC3(DistMs.ClustSmall==2));
    c3L(2,r) = mean(CC3(DistMs.ClustSmall==1)) - mean(CC3(DistMs.ClustSmall==3));
    ...
    c4L(1,r) = mean(CC4(DistMs.ClustBig==1)) - mean(CC4(DistMs.ClustBig==2));
    c4L(2,r) = mean(CC4(DistMs.ClustBig==1)) - mean(CC4(DistMs.ClustBig==3));
